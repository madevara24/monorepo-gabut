...
const file_proto_greeting_proto_rawDesc = "" +
	...
	"\bSayHello\x12\x16.greeting.HelloRequest\x1a\x14.greeting.HelloReply\"\x00\x12B\n" +
	"\x0eSayHelloStream\x12\x16.greeting.HelloRequest\x1a\x14.greeting.HelloReply\"\x000\x01B>Z<github.com/madevara24/monorepo-gabut/try-grpc/proto/greetingb\x06proto3"
...
var file_proto_greeting_proto_depIdxs = []int32{
	...
	0, // 1: greeting.GreetingService.SayHelloStream:input_type -> greeting.HelloRequest
	1, // 2: greeting.GreetingService.SayHello:output_type -> greeting.HelloReply
	1, // 3: greeting.GreetingService.SayHelloStream:output_type -> greeting.HelloReply
